...
<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    ...
    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
        ...
        <ul class="menu-nav">
            ...
            <!--end::Attributes-->
            <!--begin::Sellers-->
            <li class="menu-item {{ Request::is('*/admin/seller*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="{{ route('seller.index', app()->getlocale() ) }}" class="menu-link">
                    <span class="svg-icon menu-icon">
                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                            ...
                            <desc>Created with Sketch.</desc>
                            <defs></defs>
                            <g id="Stockholm-icons-/-Files-/-User-folder" stroke="none" stroke-width="1" fill="none"
                                fill-rule="evenodd">
                                <rect id="bound" x="0" y="0" width="24" height="24"></rect>
                                <path
