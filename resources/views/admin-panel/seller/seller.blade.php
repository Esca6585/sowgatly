        ...
        <div class="d-flex align-items-center">
            ...
            <button class="btn btn-hover-text-primary p-0 ml-2" id="kt_header_mobile_topbar_toggle">
                <span class="svg-icon svg-icon-xl">
                    <!--begin::Svg Icon | path:assets/media/svg/icons/General/seller.svg-->
                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('seller.index', [ app()->getlocale() ]) }}" class="text-muted">{{ __('Sellers') }}</a>
                                        </li>
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom">
                                ...
                                <div class="card-body">
                                    ...
                                    <!--begin: Datatable-->
                                    @include('admin-panel.seller.seller-table')
                                    <!--end: Datatable-->
                                </div>
                            </div>
                            <!--end::Card-->
