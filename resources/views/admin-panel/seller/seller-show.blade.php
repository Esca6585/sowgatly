                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom card-stretch gutter-b">
                                <div class="card-body p-15 pb-20">
                                    <div class="row mb-17">
                                        ...
                                        <div class="col-xxl-7 pl-xxl-11">
                                            <h4 class="font-weight-bolder text-dark mb-7">{{ $seller->first_name }}</h4>
                                            <h4 class="font-weight-bolder text-dark mb-7">{{ $seller->last_name }}</h4>
                                            <h4 class="font-weight-bolder text-dark mb-7">{{ $seller->email }}</h4>
                                            <h4 class="font-weight-bolder text-dark mb-7">{{ $seller->phone_number }}</h4>
                                        </div>
                                        ...
                                        <div class="section__container__body mx-4 mt-10">
                                            <div class="section__container__word">
                                                ...
                                                <div class="section__sample">
                                                    <x-user.blank.company :id="$seller->id" />
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-footer d-flex justify-content-between">
                                    ...
                                    <a href="{{ route(Request::segment(3) . '.edit', [ app()->getlocale(), $seller->id ] ) }}"
                                        title="{{ __('Edit') }}"
