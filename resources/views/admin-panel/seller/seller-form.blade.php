...
@section('title')
{{ __('Sellers') }} {{ __( ucfirst(request()->segment(count(request()->segments())))) }}
@endsection
                            ...
                            <div class="card card-custom">
                                <div class="card-header flex-wrap py-5">
                                    <div class="card-title">
                                        <h3 class="card-label">{{ __('Sellers') }}
                                ...
                                @if($seller->id)
                                <form
                                    action="{{ route(Request::segment(3) . '.update', [ app()->getlocale(), $seller->id ] ) }}"
                                    ...
                                    <form action="{{ route(Request::segment(3) . '.store', [ app()->getlocale() ] ) }}"
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $seller->name ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('name') : '' }}" />
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $seller->phone_number ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('phone_number') : '' }}" />
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password"
                                                                ...
                                                                value="{{ request()->segment(count(request()->segments())) == 'create' ? old('password_confirmation') : '' }}" />
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select
                                                                ...
                                                                @if($seller->id)
                                                                <option value="1"
                                                                    {{ $seller->status == 1 ? 'selected' : '' }}>
                                                                    {{ __('Active') }}</option>
                                                                <option value="0"
                                                                    {{ $seller->status == 0 ? 'selected' : '' }}>
                                                                    {{ __('Inactive') }}</option>
                                                                @else
                                                                <option value="1">
                                                                    {{ __('Active') }}</option>
                                                        ...
                                                        <div class="col m-5">
                                                            <div class="image-input image-input-outline" id="kt_image_1"
                                                                ...
                                                                <div class="image-input-wrapper"
                                                                    style="background-image: url({{ asset($seller->image) }})">
                                                                </div>
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <button type="submit" title="{{ $seller->id ? __('Edit') : __('Create') }}"
                                                class="btn {{ $seller->id ? 'btn-warning' : 'btn-primary' }} font-weight-bolder">
                                                <span class="svg-icon svg-icon-md">
                                                    @if($seller->id)
                                                    <span
                                                        class="svg-icon svg-icon-md {{ $seller->id ? 'svg-icon-dark' : '' }}">
                                                ...
                                                <span class="{{ $seller->id ? 'text-dark' : '' }}">
                                                    {{ $seller->id ? __('Edit') : __('Create') }}
                                                </span>
                                            </button>
                                        </div>
                                    </form>
